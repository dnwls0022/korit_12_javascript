...
console.log(lastIndexNum); //결과 37 왜?
/**
...
*/
console.log(strFruits.substr(7,6));
// 결과값 : Banana
/**
...
// 결과값 : Please visit Jeju and Seoul
/*
 argument와 일치하는 문자열 중 처음 발견된 것을 두 번째 argument로 대체함. 처음 Seoul이 발견되었고 이를 Jeju로 바꿈
*/
...
//공백부터 다시체크, 함수체크, 향상된 for문 다시체크 구조
